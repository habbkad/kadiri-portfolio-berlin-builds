      ...
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 fade-in-delay">
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            Dedicated and ambitious software developer with <span className="text-primary font-semibold">3+ years</span> of hands-on experience in full-stack development. 
            Proven mentor and team collaborator, passionate about clean code, scalable architecture, and continuous learning.
          </p>

          <div className="flex justify-center gap-4 pt-4">
            <Button variant="outline" size="lg" asChild className="group hover-lift glass-effect">
